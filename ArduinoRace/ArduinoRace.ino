...
#define TFT1drawPixel(a, b, c) TFT1.setAddrWindow(a, b, a, b); TFT1.pushColor(c)
  ...
  do {
    ...
    do {
      ...
      do {
        TFT1tmps2 = 1 - 1; //scale
        do {
          TFT1drawPixel(raketpx + TFT1tmps1, raketpy + TFT1tmps2, raket8x8[TFT1tmpx + (TFT1tmpy * raketW)]);
          } while (TFT1tmps2--);
      } while (TFT1tmps1--);
    } while (TFT1tmpy--);
  } while (TFT1tmpx--);
  ...
  do {
    ...
    do {
      ...
      do {
        TFT1tmps2 = 2 - 1; //scale
        do {
          TFT1drawPixel(raketstartpx + TFT1tmps1, raketstartpy + TFT1tmps2, raketstart8x8[TFT1tmpx + (TFT1tmpy * raketstartW)]);
          } while (TFT1tmps2--);
      } while (TFT1tmps1--);
    } while (TFT1tmpy--);
  } while (TFT1tmpx--);
